...
public class SmddActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SmddActivity.this);
                    builder.setTitle("提示")
                            .setMessage(str)
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        spQu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                if(kubie.equals("B40")){
                                    list_pai = JSON.parseArray(getJson("pai2.json", SmddActivity.this), String.class);
                                }else {
                                    list_pai = JSON.parseArray(getJson("pai.json", SmddActivity.this), String.class);
                                }
...
//                        String query = "select * from  YG_DDXXM where INVID = "+invId;
                        Cursor cursor = db.rawQuery("SELECT * FROM YG_DDXXM WHERE INVID=?", new String[]{invId});

...
public class SmxcccActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SmxcccActivity.this);
                    builder.setTitle("提示")
                            .setMessage(str)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smxccc);
        ...
        spKubie.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter<Ku.DataBean.KubieBean.KuBean> adapter1 = new ArrayAdapter<>(SmxcccActivity.this, android.R.layout.simple_spinner_item, list_ku);
                ...
                spKu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        ArrayAdapter<Ku.DataBean.KubieBean.KuBean.QvBean> adapter2 = new ArrayAdapter<>(SmxcccActivity.this, android.R.layout.simple_spinner_item, list_qv);
...
//                    }
//                } else {
//                    Toast.makeText(SmxcccActivity.this, "请先确认库区", Toast.LENGTH_SHORT).show();
//                }
//            }
//
//            @Override
...
//        });
    ...
    class querykcddinfoHandler implements Runnable {
        ...
        public void run() {
            ...
            String scannerhwtmtext = code.getText().toString().trim();
            if (scannerhwtmtext.endsWith("\n")) {
                scannerhwtmtext = scannerhwtmtext.substring(0, scannerhwtmtext.length());
            }
            String invId = "";
            ...
            if (!(scannerhwtmtext.contains("#"))) {
                data = String.format("%-10s", "SHHL34") + "B"
                        + String.format("%-20s", e) + "*";
            } else {
                data = String.format("%-10s", "SHHL34") + "B"
                        + String.format("%-51s", e) + "*";
...
//                        String query = "select * from  YG_XCXXM where INVID = "+invId;
                        Cursor cursor = db.rawQuery("SELECT * FROM YG_XCXXM WHERE INVID=?", new String[]{invId});
                        ...
                        String insert = "insert into YG_XCXXM(INVID,SCHDNO,ORDERLENGTH,ORDERTHICK,THEOWGT,REALWTG,PRODSPECNO,KUBIE,KU,QU,PAI) "
                                + " values ('" + invId + "'" + ",'" + schdNo + "','"

...
import invonate.cn.ygscanner.Fragment.Smrkqr;
import invonate.cn.ygscanner.Fragment.SmrkqrDelete;
...
public class SmrkqrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smrkqr);
        setTitle("扫描入库确认");
    ...
    private void initFragment() {
        Smrkqr s = new Smrkqr();
        fragments[0] = s;
        SmrkqrDelete sd = new SmrkqrDelete();
        fragments[1] = sd;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_all:
                ...
                break;
            case R.id.forward:
                Intent intent = new Intent(SmrkqrActivity.this, SmrkActivity.class);
    ...
    private void deleteAll() {
        db.execSQL("Delete FROM YG_RKXXM");
        ((Smrkqr) fragments[0]).clear();
        ((SmrkqrDelete)fragments[1]).clear();
    }
    ...
    class qurenkcddinfoHandler implements Runnable {
        ...
        public void run() {
            ...
            Cursor cur = db.rawQuery("SELECT invid FROM YG_RKXXM ", null);
            String hhhh1 = "";
            int i = 0;
            if (cur.getCount() != 0) {
            ...
            String data = String.format("%-10s", "SHHL37") + "A"
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SmrkqrActivity.this);
                ...
                case 1:
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SmrkqrActivity.this);
                    builder.setTitle("提示")
                            .setMessage("入库成功" + "\n" + "入库单号为：" + loadstatemessage)
                            .setPositiveButton("确认", null)
                            .create().show();
                    ((SmrkqrDelete) fragments[1]).clear();
                    getSum();

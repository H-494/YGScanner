...
import invonate.cn.ygscanner.SmckqrActivity;
import invonate.cn.ygscanner.Util.DatabaseHelper;

public class SmckqrDelete extends Fragment {
...
//                deleteItem.setTitleColor(Color.RED);
        ...
        Cursor cursor = db.rawQuery("SELECT INVID,REALWTG,ORDERTHICK,PRODSPECNO,THEOWGT FROM YG_CKXXM ", null);
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        int result = db.delete("YG_CKXXM", "INVID=?", new String[]{invId});
                        if (result > 0) {
                            list_goods.remove(position);
                            adapter.notifyDataSetChanged();
                        }
                        ((SmckqrActivity) getActivity()).getSum();
                    }

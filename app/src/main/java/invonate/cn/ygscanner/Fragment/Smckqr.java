...
public class Smckqr extends Fragment {
    ...
    public void getData() {
        if (db != null) {
            ...
            Cursor cursor = db.rawQuery("SELECT schdno,count(*) as js,sum(realwtg) as realwtg ,orderthick,prodspecno,sum(theowgt) as theowgt FROM YG_CKXXM group by schdno", null);

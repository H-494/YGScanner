...
import invonate.cn.ygscanner.SmrkqrActivity;
import invonate.cn.ygscanner.Util.DatabaseHelper;

public class SmrkqrDelete extends Fragment {
...
//                deleteItem.setTitleColor(Color.RED);
        ...
        Cursor cursor = db.rawQuery("SELECT INVID,REALWTG,ORDERTHICK,PRODSPECNO,THEOWGT FROM YG_RKXXM ", null);
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        int result = db.delete("YG_RKXXM", "INVID=?", new String[]{invId});
                        if (result > 0) {
                            list_goods.remove(position);
                            adapter.notifyDataSetChanged();
                        }
                        ((SmrkqrActivity) getActivity()).getSum();
                    }

...
import invonate.cn.ygscanner.SmddqrActivity;
import invonate.cn.ygscanner.Util.DatabaseHelper;

public class SmddqrDelete extends Fragment {
...
//                deleteItem.setTitleColor(Color.RED);
        ...
        Cursor cursor = db.rawQuery("SELECT INVID,REALWTG,ORDERTHICK,PRODSPECNO,THEOWGT FROM YG_DDXXM ", null);
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        int result = db.delete("YG_DDXXM", "INVID=?", new String[]{invId});
                        if (result > 0) {
                            list_goods.remove(position);
                            adapter.notifyDataSetChanged();
                        }
                        ((SmddqrActivity) getActivity()).getSum();
                    }

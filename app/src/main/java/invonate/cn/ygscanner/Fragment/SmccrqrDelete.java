...
public class SmccrqrDelete extends Fragment {
...
//                deleteItem.setTitleColor(Color.RED);
        ...
        Cursor cursor = db.rawQuery("SELECT INVID,REALWTG,ORDERTHICK,PRODSPECNO,THEOWGT FROM YG_FHXXM ", null);
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        int result = db.delete("YG_FHXXM", "INVID=?", new String[]{invId});
                        if (result > 0) {

...
public class SmccrkqxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smccrkqx);
        setTitle("扫描产出入库取消");
...
//                    }
    ...
    class querykcddinfoHandler implements Runnable {
        ...
        public void run() {
            ...
            if (!(scannerhwtmtext.contains("#"))) {
                data = String.format("%-10s", "SHHL42") + "A"
                        + String.format("%-20s", e) + "*";
            } else {
                data = String.format("%-10s", "SHHL42") + "A"
                        + String.format("%-51s", e) + "*";
    ...
    class CancelHandler implements Runnable {
        ...
        public void run() {
            ...
            String data = String.format("%-10s", "SHHL39") + "A"
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SmccrkqxActivity.this);
                    builder.setTitle("提示")
                            .setMessage(str)
                ...
                case 2:
                    ...
                    weight.setText("");
                    length.setText("");
                    Toast.makeText(SmccrkqxActivity.this, s, Toast.LENGTH_SHORT).show();
                    break;
            }
